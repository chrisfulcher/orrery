...
``orrery summarize`` walks the notices that have a fetched description and no row for the
...
from orrery import ai, db, documents, workspace
from orrery.assess import clip
