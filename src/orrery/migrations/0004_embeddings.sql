...
-- Derived and rebuildable: DELETE FROM embeddings WHERE model = ?; then `orrery embed`.
...
CREATE TABLE embeddings (
    ...
    model         TEXT NOT NULL,  -- ORRERY_EMBED_MODEL at embed time; re-embedding is per model
