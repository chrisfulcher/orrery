...
- `notices.description` is plain text from every source. Attachment paths are stored relative to `ORRERY_DATA_DIR`. Fetch failures are recorded, never retried automatically.
